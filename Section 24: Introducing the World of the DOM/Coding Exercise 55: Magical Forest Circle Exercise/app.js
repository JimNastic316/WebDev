...
//     Select the image and use JavaScript to give it a width of 
//     150px and a border radius of 50%
    
// Remember to use camelCased property names in JavaScript! (backgroundColor, 
// not background-color, etc.) 

const txtCntr = document.querySelector('#container');
const treeImage = document.querySelector('img');
txtCntr.style.textAlign = 'center';
